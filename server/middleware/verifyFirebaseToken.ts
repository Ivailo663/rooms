...
import type { AuthenticatedLocals, EmptyBody, EmptyParams } from "../types/auth.js";

type AuthenticatedRequest = Request<EmptyParams, unknown, EmptyBody, unknown, AuthenticatedLocals>;
